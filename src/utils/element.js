    ...
    switch(type){
        ...
        case TOOL_ITEMS.LINE:
            ...
            case TOOL_ITEMS.CIRCLE:
                const center_x=(x1+x2)/2; const center_y=(y1+y2)/2;
                const width=(x2-x1); const height=(y2-y1);
                element.roughEle=gen.ellipse(center_x,center_y,width,height,options);
                return element;

            case TOOL_ITEMS.ARROW:
                const{x3,y3,x4,y4}=getArrowHeadsCoordinates(x1,
                    y1,
                    x2,
                    y2,
                    ARROW_LENGTH
